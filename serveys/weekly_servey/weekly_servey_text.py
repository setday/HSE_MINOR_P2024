...
text_question_1 = 'Подскажи, замечал ли ты какие-либо закономерности в своих навязчивых идеях или компульсиях на этой неделе?'
text_question_2 = 'Хорошо! А какие стратегии помогли тебе справиться с симптомами ОКР в период этой недели?'
text_question_3 = 'Отлично! А с чем был связан твой последний приступ ОКП?'
text_question_4 = 'Понял! Оцени тяжесть последствий приступа от 1 до 10.'
text_question_5 = 'Какие эмоции ты испытал во время приступа?'
text_question_6 = 'Повлиял ли приступ на твой день, на психоэмоциональное состояние?'
