...
text_question = [
    'Были ли у тебя проявления ОКР (компульсии, обсессии) за последние 5 часов?',
    'Какие эмоции ты испытал во время приступа?',
    'Что стало триггером для приступа?',
    'Оцени тяжесть последствий приступа от 1 до 10.\n(1 - минимальный уровень, 10 - максимальный)',
